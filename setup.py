...
def write_version(filename='hawki_etc/version.py'):
...
def setup_sp():
    ...
    setuptools.setup(
        ...
        license="MIT",
        url="https://github.com/miguelverdugo/HAWKI_ETC",
        package_dir={'hawki_etc': 'hawki_etc'},
        packages=['hawki_etc'],
        package_data={'hawki_etc': ['hawki_etc/data/*']},
